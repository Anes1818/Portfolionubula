...
(function(){
  ...
  var ES={
    annc:'PEDIDOS POR DM O MENSAJE · <b>CADA PRECIO EN LA TARJETA</b> · OKLAHOMA CITY',
    ...
    dep:'Te confirmamos disponibilidad y tu total antes de cerrar el pedido.',
    ...
    order_dm:'💬 DM por Instagram', order_txt:'📱 Mensaje',
    ...
    rev2:'“Por fin una floristería que muestra precios. Sin ‘llame para cotizar’, sin juegos. Le escribí, me confirmó el total enseguida y quedó perfecto.”',
    ...
    faq1q:'¿Cómo hago un pedido?', faq1a:'Por DM en Instagram o TikTok, o por mensaje de texto al <b>(405) 862-6632</b>. Cuéntanos el ramo, la fecha y para quién es — te confirmamos disponibilidad y el total por DM o mensaje.',
    faq2q:'¿Cómo pago?', faq2a:'No hay pago en línea en este sitio — cada pedido se coordina por DM o mensaje. Ashley te responde con tu total y cómo pagarlo, y tu ramo se arma fresco para tu fecha.',
    ...
    faq4q:'¿Y si quiero cambiar un ramo?', faq4a:'Abre el Estudio de Ramos desde el menú — cambia tallos, envolturas y listones y ve el precio actualizarse en vivo, y luego envíanos tu diseño por DM o mensaje.',
    ...
    g2b:'Confirmado por mensaje', g2s:'tu fecha y tu total, acordados antes de armar',
